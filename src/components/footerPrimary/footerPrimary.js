  ...
  return (
    <>
      <div className="site-footer-primary">
        <div className="site-footer-primary__container container">
          <div className="site-footer-primary__column">
            <h4>About</h4>
            <ul>
              <li><a href="www.google.com">Press</a></li>
              <li><a href="www.google.com">Blog</a></li>
              <li><a href="www.google.com">Gifts</a></li>
              <li><a href="www.google.com">Team</a></li>
              <li><a href="www.google.com">Enterprise</a></li>
            </ul>
          </div>
          ...
          <div className="site-footer-primary__column">
            <h4>Support</h4>
            <ul>
              <li><a href="www.google.com">Help/FAQ</a></li>
              <li><a href="www.google.com">Accessibility</a></li>
              <li><a href="www.google.com">Publishers</a></li>
              <li><a href="www.google.com">Advertisers</a></li>
            </ul>
          </div>
          ...
          <div className="site-footer-primary__column">
            ...
            <ul>
              ...
              <li><a href="www.google.com">Copyright</a></li>
              <li><a href="www.google.com">Cookie policy</a></li>
            </ul>
          </div>

          <div className="site-footer-primary__column site-footer-primary__column--social">
            <h4>Social</h4>
            <ul>
              <li>
                <span className="BXcwMH _VbDNs"
                ><svg
                  width="16"
                  height="16"
                  fill="none"
                ...
                >
                    <path
                      ...
                      fill="currentColor"
                    ></path></svg
                  ><span className="visually_hidden">Instagram</span></span
              ...
              <li>
                ...
                >
                    <path
                      ...
                      fill="currentColor"
                    ></path></svg
                  ><span className="visually_hidden">Twitter</span></span
              ...
              <li>
                ...
                >
                    <path
                      ...
                      fill="currentColor"
                    ></path></svg
                  ><span className="visually_hidden">Facebook</span></span
              ...
              <li>
                ...
                >
                    <path
                      ...
                      fill="currentColor"
                    ></path></svg
                  ><span className="visually_hidden">Pinterest</span></span
                ><a href="www.google.com">Linkedin</a>
              </li>
            </ul>
          </div>

          <div className="site-footer-primary__column site-footer-primary__column--free-aps">
            <h4>Free Apps</h4>
            <ul>
              <li>
      ...
      <div className="footer-container-divider">
        <div className="container container-divider"></div>
      </div>
    </>
  )
}
